        ...
        <div class="col-5">
            <form method="POST" action="{{ route('login') }}">
                ...
                <table>
                    ...
                    <tr>
                        <th>パスワード</th>
                        <td><input type="password" class="form-control" size="50" name="password"></td>
                    </tr>
                    <tr>
                        <th></th>
                        <td><input type="submit" class="form-control" value="ログイン"></td>
                    </tr>
                </table>
            </form>
        </div>
        ...
        @foreach ($articles as $article)
            <div class="article-box">
                ...
                <div class="article-box-right">
                    <a class="article-title" href="/drafts/{{ $article->id }}">
                        {{ $article->title }}
                    </a>
